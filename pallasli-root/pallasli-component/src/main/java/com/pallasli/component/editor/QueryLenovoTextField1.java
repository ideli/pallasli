...
public class QueryLenovoTextField1 extends IQueryEditor{
	...
	public JsonObject getEditor(Column column, User user) {
		...
		if (column.getF_config() != null && !column.getF_config().isJsonNull()&& column.getF_config().has("paramarry")) {
			String s_cs = column.getF_config().get("paramarry").getAsString();
