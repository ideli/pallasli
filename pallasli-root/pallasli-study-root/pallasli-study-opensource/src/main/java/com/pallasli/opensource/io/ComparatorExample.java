...
public final class ComparatorExample {
	...
	private static final String FILE_1 = "C:UsersLilykosworkspaceApacheCommonsExampleExampleFolderexample";

	private static final String FILE_2 = "C:UsersLilykosworkspaceApacheCommonsExampleExampleFolderexampleTxt.txt";
	...
	public static void runExample() {
		...
		for (File file : sizeFiles) {
			System.out.println("t" + file.getName() + " with size (kb): "
					+ file.length());
		}
		...
		for (File file : lastModifiedFiles) {
			...
			System.out.println("t" + file.getName() + " last modified on: "
					+ modified);
		}
