package com.pallasli.study.ws.cxf.interceptor;
 ...
 * @version 1.0
 */
public class ClientMessageInterceptor extends AbstractPhaseInterceptor<Message> {

	// 至少要一个带参的构造函数
	public ClientMessageInterceptor(String phase) {
		super(phase);
	}
