package pallasli.study.mq.activemq.openwire.TopicPubSubSamples.SelectorChat;
	...
	private void chatter(String broker, String username, String password, String selection) {
		...
		try {
			...
			System.out.println("\nSelectorChat application:\n" + "===========================\n"
					...
					+ "The application also subscribes to that topic, selecting only messages where " + PROPERTY_NAME
					+ " is " + selection + ".\n"
