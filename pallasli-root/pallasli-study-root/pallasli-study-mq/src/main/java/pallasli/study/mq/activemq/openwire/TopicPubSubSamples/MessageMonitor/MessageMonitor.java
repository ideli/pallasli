package pallasli.study.mq.activemq.openwire.TopicPubSubSamples.MessageMonitor;
...
public class MessageMonitor extends JFrame {
	...
	public class Subscription implements javax.jms.MessageListener {
		...
		/**
		 * Handle the text message (as specified in the
		...
		public void onMessage(javax.jms.Message message) {
			...
			try {
				...
				textArea.append("The following message, received on topic "
						+ ((Topic) message.getJMSDestination()).getTopicName() + ", was sent by\n");
				// textArea.append("\n");
