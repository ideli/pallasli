package pallasli.study.mq.activemq.openwire.QueuePTPSamples.TransactedTalk;
...
public class TransactedTalk implements javax.jms.MessageListener {
	private static final String DEFAULT_BROKER_NAME = "tcp://localhost:61616";
	private static final String DEFAULT_PASSWORD = "password";
	private static final int MESSAGE_LIFESPAN = 1800000; // milliseconds (30
															// minutes)
	...
	private void talker(String broker, String username, String password, String rQueue, String sQueue) {
		...
		try {
			...
			// but not affect messages received. Therefore, we need two
			// sessions.
