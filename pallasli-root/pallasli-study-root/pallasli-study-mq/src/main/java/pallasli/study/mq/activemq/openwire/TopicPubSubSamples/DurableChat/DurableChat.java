package pallasli.study.mq.activemq.openwire.TopicPubSubSamples.DurableChat;
...
public class DurableChat implements javax.jms.MessageListener // to handle
																// message
																// subscriptions
{
				...
				if (s == null) {
					...
					try {
						...
						publisher.send(msg, // message
								javax.jms.DeliveryMode.PERSISTENT, // publish
																	// persistently
