...
public class Watermark2 {
	 ...
	 * 在源图片上设置水印文字
	 */
	public void WordsToImage(String srcImagePath, float alpha, String font,
	...
	public static void main(String[] args) throws Exception {
		...
		imageObj.WordsToImage(srcImagePath, alpha, font, fontStyle, fontSize,
				color, inputWords, x, y, imageFormat, wToPath);
		imageObj.ImageToImage(srcImagePath, appendImagePath, alpha, x, y, 300,
				200, imageFormat, IToPath);
