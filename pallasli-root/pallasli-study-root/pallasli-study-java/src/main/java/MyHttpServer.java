...
public class MyHttpServer {
	...
	public static String WEB_ROOT = "/test";
	// 端口
	private int port;
	// 用户请求的文件的url
	...
	private void doPost(DataInputStream reader, OutputStream out)
		...
		response += "/n";
		String body = "post ok:" + new String(buf, 0, size) + "";
	...
	public static void main(String args[]) throws Exception {
		MyHttpServer server = new MyHttpServer("/test", 8080);
		server.service();
	}
}
