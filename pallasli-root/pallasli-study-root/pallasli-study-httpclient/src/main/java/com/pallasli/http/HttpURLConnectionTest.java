...
public class HttpURLConnectionTest {
	...
	public static void main(String[] args) throws Exception {
		...
		String currentUrl = "http://localhost:8080/designer/home"; // URL
																	// ?后面的内容为HTTP请求的正文
		...
		httpurlconnection.setRequestProperty("Accept-Charset",
				CommonValues.Accept_Charset);
		httpurlconnection.setRequestProperty("Accept-Language",
				CommonValues.Accept_Language);

		httpurlconnection.setRequestProperty("Connection",
				CommonValues.Connection);
		httpurlconnection.setRequestProperty("Keep-Alive",
				CommonValues.Keep_Alive);
		// 设置代理ip,getHeader("X-Forwarded-For")将拿不到真是ip但request.getRemoteAddr()
		httpurlconnection
				.setRequestProperty("X-Forwarded-For", "112.211.0.125");
	...
	public static final String GET_URL = "http://localhost:8080/designerApp/home.html";

	public static final String POST_URL = "http://localhost:8080/designerApp/home.html";
