...
Ext.onReady(function(){
	...
	var nodePanel = new Ext.Panel({
		...
		autoLoad : {
			url : 'administrator/workflow/node.do',
			scripts:true,
			border:false,
			params:{
				id : 'node-<%=key%>'
	...
	var routePanel = new Ext.Panel({
		...
		deferredRender:false,
		autoLoad : {
			url : 'administrator/workflow/route.do',
			scripts:true,
			border:false,
			params:{
				id : 'route-<%=key%>'
	...
	var relationPanel = new Ext.Panel({
		...
		deferredRender:false,
		autoLoad : {
			url : 'administrator/workflow/relation.do',
			scripts:true,
			border:false,
			params:{
				id : 'relation-<%=key%>'
	...
	panel.savePosition = function(){
		...
		FlowDesignerDirect.saveFlowPosition('<%=key%>', cellsPos, edgesPos, function(result, e){
			if(result && result.success){
	...
	panel.on('activate', function(){
		...
		var style = mxUtils.load('resources/js/administrator/workflow/flow-style.xml').getDocumentElement();
