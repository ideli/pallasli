...
Ext.onReady(function(){
	var id = '<%=id%>';
	var mclass = 'relation';
	var module = Mixky.awsoft.lib.Class.getModule(mclass);
    ...
    var AddAction = new Ext.Action({
		...
		handler:function(){
			...
			Mixky.awsoft.lib.addDesignObject(panel.key, mclass, function(newkey, mclass){
				panel.refresh();
			});
		}
	});
    var CopyAction = new Ext.Action({
		...
		handler:function(){
			...
			Mixky.awsoft.lib.Context.clipboardObject = {key:record.get('key'), mclass:mclass};
		}
	});
