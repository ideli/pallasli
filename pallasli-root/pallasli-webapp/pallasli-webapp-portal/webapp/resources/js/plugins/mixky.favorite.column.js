 ...
 * a column.
 */
Mixky.wasoft.favorite.FavoriteColumn = function(config){
...
Mixky.wasoft.favorite.FavoriteColumn.prototype ={
    init : function(grid){
        this.grid = grid;
    ...
    onMouseDown : function(e, t){
        if(t.className && t.className.indexOf('x-grid3-cc-'+this.id) != -1){
            ...
            var value = 0;
            if(!record.data[this.dataIndex] || record.data[this.dataIndex] == 0){
            	value = 1;
            }
            ...
            var field = this;
            Mixky.wasoft.lib.updateFavorite(this.applicationkey, documentkey, srcid, title, value, function(success){
