...
Mixky.editor.PanelTriggerField = Ext.extend(Ext.form.TriggerField, {
	...
	return Mixky.editor.PanelTriggerField.superclass.setValue.call(this, v);
    },
	...
	this.restrictHeight();
	this.list.alignTo(this.wrap, this.listAlign);
	if(Ext.isDefined(this.panel) && Ext.isDefined(this.panel.beforeexpend)){
	    this.panel.beforeexpend(this);
	}
	this.list.show();
	if(Ext.isGecko2){
...
Ext.reg('mixkypaneltriggerfield', Mixky.editor.PanelTriggerField);