package com.pallasli.bpm.rest.bpmtest;
...
@Controller(value = "bpmTestContoller")
@RequestMapping("/bpmtest")
class BpmTestContoller {
	...
	@RequestMapping(value = "/taskDoingList", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/taskDoneList", method = RequestMethod.GET)
	@ResponseBody
