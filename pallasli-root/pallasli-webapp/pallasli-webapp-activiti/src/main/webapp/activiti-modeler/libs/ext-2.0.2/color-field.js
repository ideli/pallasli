/**
 * @class Activiti20.ux.ColorField
 * @extends Activiti20.form.TriggerField
 * Provides a color input field with a {@link Activiti20.ColorPalette} dropdown.
* @constructor
* Create a new ColorField
 * <br />Example:
 * <pre><code>
var color_field = new Activiti20.ux.ColorField({
	fieldLabel: 'Color',
	id: 'color',
	width: 175,
	allowBlank: false
...
Activiti20.ux.ColorField = Activiti20.extend(Activiti20.form.TriggerField,  {
    /**
    ...
    validateValue : function(value){
        if(!Activiti20.ux.ColorField.superclass.validateValue.call(this, value)){
            return false;
        }
     ...
     */
    getValue : function(){
        var value = Activiti20.ux.ColorField.superclass.getValue.call(this) || "";
    ...
    setValue : function(color){
        ...
        Activiti20.ux.ColorField.superclass.setValue.call(this, color);
		this.setColor(color);
    },
    ...
    onTriggerClick : function(){
        ...
        if(this.menu == null){
            this.menu = new Activiti20.menu.ColorMenu();
        }
	...
	onDestroy : function(){
    	...
    	Activiti20.ux.ColorField.superclass.onDestroy.call(this);
	}
});

Activiti20.reg('colorfield',Activiti20.ux.ColorField);
