...
new function(){
	...
	Signavio.Utils.extractValue = function(record, query){
		...
		// Get value
		var val = record instanceof Activiti20.data.Record ? record.get(o[0]) : record[o[0]];
		var i	= 0;
...
//			}
			...
			// @overwrite
			var inHtml = Activiti20.DomHelper.insertHtml;
			Activiti20.DomHelper.insertHtml = function(foo, bar, html){
			...
			Activiti20.tree.TreeEventModel.prototype.getNode = function(e){
		        var t;
		        if(t = e.getTarget('.x-tree-node-el', 10)){
		            var id = Activiti20.fly(t, '_treeEvents').dom.getAttributeNS(null, 'tree-node-id');
		            if(id){
		    ...
		    Activiti20.Template.prototype.overwrite = function(el, values, returnElement){
