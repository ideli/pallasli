...
<%@ page import="com.mixky.engine.design.document.AuthorityMap"%>
...
<%
	for (String o : map.keySet()){
		out.print("<TR>");
		out.print("<TD><image border=0 src='resources/designer/" + map.get(o).getObject().getF_class() + ".gif'> &nbsp;&nbsp;" + map.get(o).getObject().getF_class());
...
<br>
<br>
<center><B><A id='avf-<%=appkey%>-<%=document.getF_key()%>-<%=documentid%>' href=#>刷新</A></B></center>
<br>
...
Ext.onReady(function(){
	...
	// 处理链接
	Ext.fly('avf-<%=appkey%>-<%=document.getF_key()%>-<%=documentid%>').on('click', function(){
		panel.refresh();
	});
});
</script>