...
<%
	...
	if(!unid.trim().equals("")){
	    ...
	    processitem = ProcessClient.instance().getProcessItem(json, unid, docid, user.getGrbh());
	    fieldauths = TableFormDataService.instance().getBpmFieldAuth(panel.getF_key(),processitem, fieldauths, type);
	}
	JsonArray formLayout = TableFormDataService.instance().getFormColumnLayout(tableform);
