Ext.define('Pallas.extDesigner.shape.drag.DD', {
	extend : 'Ext.dd.DragSource',
	requires : [ 'Pallas.extDesigner.shape.drag.Proxy' ],
	...
	constructor : function(panel, cfg) {
		...
		me.panelProxy = new Pallas.extDesigner.shape.drag.Proxy(panel, cfg);
	...
	setupEl : function(panel) {
		...
		if (el) {
			...
			// boxready fires after first layout, so we'll definitely be
			// rendered
