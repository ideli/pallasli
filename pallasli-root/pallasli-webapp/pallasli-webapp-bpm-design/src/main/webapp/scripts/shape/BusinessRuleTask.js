Ext.define('Pallas.activitiDesigner.shape.BusinessRuleTask', {
	...
	alias : [ 'widget.businessruletask' ],
	pallasName : "businessRuleTask",
	width : 100,
	height : 100,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.businessRuleTask.dragIcon;
