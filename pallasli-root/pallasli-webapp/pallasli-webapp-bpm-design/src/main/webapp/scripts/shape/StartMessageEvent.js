Ext.define('Pallas.activitiDesigner.shape.StartMessageEvent', {
	...
	alias : [ 'widget.startmessageevent' ],
	pallasName : "startMessageEvent",
	width : 50,
	height : 50,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.startMessageEvent.dragIcon;
