Ext.define('Pallas.activitiDesigner.shape.BoundaryMessageEvent', {
	...
	alias : [ 'widget.boundarymessageevent' ],
	pallasName : "boundaryMessageEvent",
	width : 50,
	height : 50,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.boundaryMessageEvent.dragIcon;
