Ext.define('Pallas.activitiDesigner.shape.BoundarySignalEvent', {
	...
	alias : [ 'widget.boundarysignalevent' ],
	pallasName : "boundarySignalEvent",
	width : 50,
	height : 50,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.boundarySignalEvent.dragIcon;
