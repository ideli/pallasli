Ext.define('Pallas.activitiDesigner.shape.CatchSignalEvent', {
	...
	alias : [ 'widget.catchsignalevent' ],
	pallasName : "catchSignalEvent",
	width : 50,
	height : 50,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.catchSignalEvent.dragIcon;
