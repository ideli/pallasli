Ext.define('Pallas.activitiDesigner.shape.InclusiveGateway', {
	...
	alias : [ 'widget.inclusivegateway' ],
	pallasName : "inclusiveGateway",
	width : 50,
	height : 50,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.inclusiveGateway.dragIcon;
