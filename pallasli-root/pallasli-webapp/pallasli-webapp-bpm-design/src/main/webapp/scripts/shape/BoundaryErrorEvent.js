Ext.define('Pallas.activitiDesigner.shape.BoundaryErrorEvent', {
	...
	alias : [ 'widget.boundaryerrorevent' ],
	pallasName : "boundaryErrorEvent",
	width : 50,
	height : 50,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.boundaryErrorEvent.dragIcon;
