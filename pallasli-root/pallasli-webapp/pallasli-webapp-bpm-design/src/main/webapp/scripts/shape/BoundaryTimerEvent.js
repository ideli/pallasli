Ext.define('Pallas.activitiDesigner.shape.BoundaryTimerEvent', {
	...
	alias : [ 'widget.boundarytimerevent' ],
	pallasName : "boundaryTimerEvent",
	width : 50,
	height : 50,
	...
	drawDragHtml : function() {
		...
		var iconPath = baseConfig.imagesDependencesPath
				+ elementsConfig.boundaryTimerEvent.dragIcon;
