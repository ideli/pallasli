...
Ext.define('MyDesktop.VideoWindow', {
    ...
    videoPath:'http://dev.sencha.com/desktopvideo',
    tipWidth: 160,
    tipHeight: 96,
                ...
                items: [
                    {
                        ...
                        src: [
                            ...
                            { src: me.videoPath+'.mp4', type: 'video/mp4' },
                            { src: me.videoPath+'.ogv', type: 'video/ogg' },
                            { src: me.videoPath+'.mov', type: 'video/quicktime' }
                        ],
