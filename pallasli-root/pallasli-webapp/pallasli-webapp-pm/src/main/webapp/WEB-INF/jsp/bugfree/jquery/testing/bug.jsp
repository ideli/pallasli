            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        ...
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">指派给我</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">由我创建</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">由我解决</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">未指派</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">未解决</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">久未处理</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">被延期</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">所有bug</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">需求变动</a>
                    ...
                    <td style="white-space:nowrap;">
                        ...
                        <a class="mini-button" iconCls="icon-add" onclick="add()">新增bug</a>
