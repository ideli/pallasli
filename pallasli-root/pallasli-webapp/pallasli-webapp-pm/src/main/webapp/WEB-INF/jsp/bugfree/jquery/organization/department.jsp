 ...
 <div style="width:auto;">
        <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        <a class="mini-button" onclick="search()">公司选择</a>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:auto;height:100%" allowResize="true"
        ...
        <div property="columns">
            ...
            <div field="loginname" width="20" headerAlign="center" allowSort="true">id</div>    
            <div field="name" width="220" headerAlign="center" allowSort="true">上级部门全称</div>      
            <div field="name" width="100" headerAlign="center" allowSort="true">部门名称</div>    
            <div field="name" width="260" headerAlign="center" allowSort="true">部门描述</div>    
              <div header="操作">
                <div property="columns">
