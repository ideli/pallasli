...
<div  class="mini-panel"  title="新增产品" style="width:auto; height:100%"  showHeader="false"  borderStyle="border:solid 0px #aaa;">
 ...
 <div id="form1"   >
        ...
        <table>
            ...
            <tr>
                <td>
                    <label for="textbox1$text">产品名称：</label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <label for="pwd1$text">产品代号：</label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <label for="textarea1$text">产品负责人：</label>
                </td>
                <td>
            ...
            <tr>
                <td>                   
                    <label for="date1$text">测试负责人：</label>
                </td>
                <td>
