 ...
 <div style="width:auto;">
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="white-space:nowrap;">
                        ...
                        <a class="mini-button" iconCls="icon-add" onclick="add()">权限管理</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">成员维护</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">编辑</a>
                        <a class="mini-button" iconCls="icon-add" onclick="edit()">复制TODO</a>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:auto;height:100%" allowResize="true"
        ...
        <div property="columns">
            ...
            <div field="name" width="60" headerAlign="center" allowSort="true">岗位名称</div>    
            <div field="name" width="40" headerAlign="center" allowSort="true">岗位描述</div>    
            <div field="name" width="40" headerAlign="center" allowSort="true">用户列表</div>    
            <div field="name" width="320" headerAlign="center" allowSort="true">权限列表</div>  
              <div header="操作">
                <div property="columns">
