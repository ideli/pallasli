...
<link rel="stylesheet" type="text/css"
	href="/pallasli-web-js-css/styles/designer/designer.css" />
...
<script type="text/javascript"
	src="<%=basePath%>/scripts/design/definedModels.js"></script>


<%
	File f = new File(request.getRealPath("/")
			+ "/scripts/designer/home/SysMenu.js");
