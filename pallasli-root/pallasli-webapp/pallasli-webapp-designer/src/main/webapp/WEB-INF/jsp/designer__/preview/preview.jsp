...
.btn-comp {
    ...
    Ext.require([
        ...
        Ext.onReady(function(){
            ...
            var treePanel = Ext.create('Ext.tree.Panel', {
                ...
                listeners:{
                	'itemcontextmenu':function(panel,record, item, index,  e,  eOpts){
                		    ...
                		    items: [{
                		        ...
                		        handler:function(){
                		        	...
                		        	editorData.children[editorData.children.length]={
                		        	 ...
                		        	 var child = treePanel.getRootNode();//.findChild('id',item.id ,true);
                		        ...
                		        handler:function(){
                		        	...
                		        	editorData.children[editorData.children.length]={
                		        	 ...
                		        	 var child = treePanel.getRootNode().findChild('text',record.data.text ,true);
                                     child  = child.appendChild({
                                         text:name,
                                         leaf:true
                                     });
                		...
                		contextmenu.items.items[2].hidden=(record.data.root||false); 
            ...
            var attributePanel = Ext.create('Pallas.common.AttributePanel', {
                title: '属性设置',
				region:"center",
				sortableColumns : false,
				id:"attributePanel",
				nameColumnWidth:100,
				columns:[{header:"属性名",dataIndex:"name"},{header:"值",dataIndex:"value"}] 
            });
	...
	//	});
		...
		var initCompCompProxy=function(comp){
			var proxy = new Ext.dd.DragSource(comp.getEl(), {group:'form_comp_drag'});
			proxy.afterDragDrop = function(target, e, id) {
				var destComp=Ext.getCmp(id);  
				var srcCompd=Ext.getCmp(proxy.id); 
	        	destComp.add(srcCompd);
		...
		Ext.each(treePanel1.items.items, function(comp) {  
			...
			proxy.afterDragDrop = function(target, e, id) {
				...
				var srcCompd=Ext.getCmp(proxy.id);
				if(!srcCompd.cType){return;}
				var srcComp=Ext.create(srcCompd.cType, Ext.apply(CompConfigMap[srcCompd.cType],{
        		...
        		destComp.add(srcComp);
	         	destComp.doLayout();
             	//new Ext.dd.DDTarget(srcComp.getEl(), 'designDD2');
	        };
		});  
