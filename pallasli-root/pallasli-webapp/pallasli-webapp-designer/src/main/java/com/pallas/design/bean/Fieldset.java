...
public class Fieldset implements Serializable {
    ...
    /** full constructor */
    public Fieldset(Long id, String projectName, String fieldsetName, String fieldsetCaption, String fieldsetConfigs, int version) {
        this.id = id;
    ...
    /** minimal constructor */
    public Fieldset(Long id, String projectName, String fieldsetName, int version) {
        this.id = id;
        this.projectName = projectName;
        this.fieldsetName = fieldsetName;
        this.version = version;
