...
public class Menu implements Serializable {
    ...
    /** full constructor */
    public Menu(Long id, String projectName, String menuKey, String parentKey, String menuName, String menuCaption, String urlPath, String childUrlPath, String menuTableName, String menuWhereSql, String menuTypeCode, String pageTypeCode, String menuConfigs, int version) {
        this.id = id;
    ...
    /** minimal constructor */
    public Menu(Long id, String projectName, String menuKey, String parentKey, String menuName, String menuCaption, String menuTypeCode, String pageTypeCode, int version) {
        this.id = id;
        this.projectName = projectName;
        this.menuKey = menuKey;
        this.parentKey = parentKey;
