...
//=================================================================
  var store = new Ext.data.JsonStore({
         ...
         idProperty: 'id',
         fields : ['id' ,'englishName', 'chineseName', 'chineseMeta' ,'simpleEnSpell', 'englishMeta'],
         sortInfo:{field:'id',direction:'DESC'},
         proxy: new Ext.data.HttpProxy({
         url: 'physicalVariable.ext?method=getInfo'
     })
   });
