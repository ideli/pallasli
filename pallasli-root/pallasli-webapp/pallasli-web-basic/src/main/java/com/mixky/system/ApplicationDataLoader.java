...
public class ApplicationDataLoader {
	...
	public void loadModuleRoleAuthFromServer() {
		// IPortalDataSyncService service =
		// PortalDataSyncServiceAccess.instance()
		// .getPortalDataSyncService();
		// if (service != null) {
		// // 从本地缓存当中清除相关数据
		// com.wa.xdatabase.cache.DataCacheFactory waDataCache =
		// com.wa.xdatabase.cache.DataCacheFactory
		// .instance();
