...
public class OutlineManager {
	...
	// items.add(createTreeNode("dictionaryfolder", "dictionaryfolder",
	// "dictionaryfolder", "数据字典", true, "dictionaryfolder", null, null));
	//
	// JsonArray moduleNodes = new JsonArray();
	// getModuleFolderNodes(moduleNodes);
	// items.add(createTreeNode("modulefolder", "modulefolder", "modulefolder",
	// "模块设计", false, "modulefolder", moduleNodes, null));
	// }
	//
	// private void getModuleMenuNodes(String key, JsonArray items){
	// List<DesignObject> modulemenus =
	// DesignObjectLoader.instance().findObjects("modulemenu", key);
	...
	// }
	// items.add(createTreeNode(child.getKey(), child.getKey(),
	// child.getF_class(), child.getF_caption(), false, child.getF_class(),
	// children, note));
	// }
	// }
	//
	// private void getTableFolderNodes(String key, JsonArray items){
	// List<DesignObject> tables =
	// DesignObjectLoader.instance().findObjects("table", key);
	...
	// }
	// items.add(createTreeNode(query.getKey(), query.getKey(),
	// query.getF_class(), query.getF_caption(), true, query.getF_class(), null,
	// note));
	// }
	// }
	//
	// private void getGroupNodes(String key, JsonArray items){
	// List<DesignObject> groups =
	// DesignObjectLoader.instance().findObjects("group", key);
	...
	// mergeDesignObjectList(querys,
	// DesignObjectLoader.instance().findObjects("group", key));
	// mergeDesignObjectList(querys,
	// DesignObjectLoader.instance().findObjects("view", key));
	...
	// }
	// items.add(createTreeNode(child.getKey(), child.getKey(),
	// child.getF_class(), child.getF_caption(), isleaf, child.getF_class(),
	// children, note));
	// }
	// }
	//
	// private void getQueryFolderNodes(String key, JsonArray items){
	// List<DesignObject> querys =
	// DesignObjectLoader.instance().findObjects("query", key);
	// DesignObjectFactory.instance().orderDesignObjectList(querys);
	// for(int i=0;i<querys.size();i++){
	...
	// }
	// items.add(createTreeNode(query.getKey(), query.getKey(),
	// query.getF_class(), query.getF_caption(), false, query.getF_class(),
	// children, note));
	// }
	// }
	//
	// private void getDocumentNodes(String key, JsonArray items){
	// List<DesignObject> panels =
	// DesignObjectLoader.instance().findObjects("panel", key);
	...
	// }
	// items.add(createTreeNode(panel.getKey(), panel.getKey(), "panel",
	// panel.getF_caption(), true, "panel", null, note));
	// }
	// }
	//
	// private void getDocumentFolderNodes(String key, JsonArray items){
	// List<DesignObject> documents =
	// DesignObjectLoader.instance().findObjects("document", key);
	...
	// }
	// items.add(createTreeNode(document.getKey(), document.getKey(),
	// "document", document.getF_caption(), false, "document", children, note));
	// }
	// }
	//
	// private void getNodeNodes(String key, JsonArray items){
	// List<DesignObject> nodes =
	// DesignObjectLoader.instance().findObjects("route", key);
	// DesignObjectFactory.instance().orderDesignObjectList(nodes,
	// "f_key,f_name");
	...
	// List<DesignObject> documenttypes =
	// DesignObjectLoader.instance().findObjects("documenttype", key);
	...
	// }
	// items.add(createTreeNode(documenttype.getKey(), documenttype.getKey(),
	// documenttype.getF_class(), documenttype.getF_caption(), true,
	// documenttype.getF_class(), null, note));
	// }
	// }
	//
	// private void getPortletFolderNodes(String key, JsonArray items){
	// List<DesignObject> portlets =
	// DesignObjectLoader.instance().findObjects("portlet", key);
	...
	// }
	// items.add(createTreeNode(portlet.getKey(), portlet.getKey(),
	// portlet.getF_class(), portlet.getF_caption(), true, portlet.getF_class(),
	// null, note));
	// }
	// }
	//
	// private void getModuleRoleFolderNodes(String key, JsonArray items){
	// List<DesignObject> moduleroles =
	// DesignObjectLoader.instance().findObjects("modulerole", key);
	...
	// }
	// items.add(createTreeNode(modulerole.getKey(), modulerole.getKey(),
	// modulerole.getF_class(), modulerole.getF_caption(), true,
	// modulerole.getF_class(), null, note));
	// }
	// if(moduleroles.size() > 0){
	// items.add(createTreeNode(key + "-auth", key, "moduleauthorityfolder",
	// "权限列表", true, "moduleauthorityfolder", null, "模块设计对象权限配置"));
	// }
	// }
	//
	...
	// items.add(createTreeNode(key + ".modulemenufolder", key,
	// "modulemenufolder", "模块菜单", false, "modulemenufolder", moduleMenuNodes,
	// null));
	// JsonArray tableNodes = new JsonArray();
	// getTableFolderNodes(key, tableNodes);
	// items.add(createTreeNode(key + ".tablefolder", key, "tablefolder", "数据表",
	// false, "tablefolder", tableNodes, null));
	// JsonArray queryNodes = new JsonArray();
	// getQueryFolderNodes(key, queryNodes);
	// items.add(createTreeNode(key + ".queryfolder", key, "queryfolder",
	// "查询定义", false, "queryfolder", queryNodes, null));
	// JsonArray documentNodes = new JsonArray();
	// getDocumentFolderNodes(key, documentNodes);
	// items.add(createTreeNode(key + ".documentfolder", key, "documentfolder",
	// "文档", false, "documentfolder", documentNodes, null));
	// JsonArray moduleroleNodes = new JsonArray();
	// getModuleRoleFolderNodes(key, moduleroleNodes);
	// items.add(createTreeNode(key + ".modulerolefolder", key,
	// "modulerolefolder", "角色定义", false, "modulerolefolder", moduleroleNodes,
	// null));
	// JsonArray documentTypeNodes = new JsonArray();
	// getDocumentTypeFolderNodes(key, documentTypeNodes);
	// items.add(createTreeNode(key + ".documenttypefolder", key,
	// "documenttypefolder", "文档类型注册", false, "documenttypefolder",
	// documentTypeNodes, null));
	// JsonArray portletNodes = new JsonArray();
	// getPortletFolderNodes(key, portletNodes);
	// items.add(createTreeNode(key + ".portletfolder", key, "portletfolder",
	// "桌面栏目", false, "portletfolder", portletNodes, null));
	// }
	// /**
	// * 列出所有模块
	// * @param items
	...
	// List<DesignObject> modules =
	// DataCacheFactory.instance().getSerializeableObjects("module");
	...
	// }
	// items.add(createTreeNode(module.getKey(), module.getKey(), "module",
	// module.getF_caption(), false, "module", children, note));
	// }
	// }
	//
	// private JsonObject createTreeNode(String id, String key, String type,
	// String text, boolean leaf, String iconCls, JsonArray children, String
	// qtip){
	...
	// }
	//
	// private void mergeDesignObjectList(List<DesignObject> first, List<Object>
	// second){
