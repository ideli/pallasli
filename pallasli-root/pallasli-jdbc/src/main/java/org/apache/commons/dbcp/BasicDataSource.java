 ...
 * <em>commons-dbcp</em> and <em>commons-pool</em> packages, but provides a
 ...
 * @version $Revision: 506087 $ $Date: 2007-02-11 11:37:43 -0700 (Sun, 11 Feb
 *          2007) $ 修改createDataSource方法，增加对sybase和os400驱动的特殊属性
 * @author luojun
 */
public class BasicDataSource implements DataSource {
	 ...
	 * statement pool at the same time, or non-positive for no limit. Since a
	 ...
	 * pool. For a <code>true</code> value to have any effect, the
	 ...
	 * the pool. For a <code>true</code> value to have any effect, the
	 * <code>validationQuery</code> property must be set to a non-null string.
	 * 
	 * @param testOnReturn
	...
	/**
	 * A property setter has been invoked that will require the connection pool
	 * to be re-initialized. Currently, restart is not triggered, so this
	 ...
	 * "double checked locking" idiom in an attempt to avoid synchronizing on
	 * every single call to this method. However, this idiom fails to work
	 * correctly in the face of some optimizations that are legal for a JVM to
	 * perform.
	 * </p>
	 * 
	 * @throws SQLException
