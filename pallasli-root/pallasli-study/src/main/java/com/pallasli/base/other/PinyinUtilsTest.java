...
public class PinyinUtilsTest {
	//
	  @Test
	  public void toFullSpelling() {
	// HanyuPinyinOutputFormat outputFormat = new HanyuPinyinOutputFormat();
	// outputFormat.setVCharType(HanyuPinyinVCharType.WITH_V);// 'u:'的三种显示
	// outputFormat.setCaseType(HanyuPinyinCaseType.LOWERCASE);// 大小写
	// outputFormat.setToneType(HanyuPinyinToneType.WITHOUT_TONE);// 声调
	//
	// try {
	// String str = "吕林";
	// String pinyin = "";
