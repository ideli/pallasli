...
public final class InputExample {
	...
	private static final String XML_PATH = "C:UsersLilykosworkspaceApacheCommonsExampleInputOutputExampleFolderweb.xml";
	...
	public static void runExample() {
		...
		try {
			...
			// and closes both using only one close() method (by defining the
			// 3rd
