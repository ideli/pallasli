...
import com.pallasli.study.ftp.extClass.FtpClient;
import com.pallasli.study.ftp.extClass.SiteInfoBean;
import com.pallasli.study.ftp.panel.ftp.FtpPanel;
import com.pallasli.study.ftp.panel.local.LocalPanel;
import com.pallasli.study.ftp.panel.manager.FtpSiteDialog;
import com.pallasli.study.ftp.panel.queue.DownloadPanel;
import com.pallasli.study.ftp.panel.queue.QueuePanel;
import com.pallasli.study.ftp.panel.queue.UploadPanel;
...
public class FTP_Client_Frame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jTabbedPane1.addTab("已上传", uploadPanel);// 添加上传面板
		jTabbedPane1.addTab("已下载", downloadPanel);// 添加下载面板
