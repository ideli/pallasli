...
var pathToImages = '/calendar/images/';//配置图片目录
...
function pickDate(e,inputDay)
{
	...
	closeCalendar();
	if(returnDateTo&&window.jQuery)jQuery(returnDateTo).trigger("blur");
}
...
function writeBottomBar()
{
	...
	subDiv.innerHTML = bottomString +"<a href='javascript:writeBottomBar.clear();' style='color:#317082;padding-left:35px;'>清空</a>";
	bottomBar.appendChild(subDiv);
	var timeDiv = writeTimeBar();
	bottomBar.appendChild(timeDiv);
	calendarDiv.appendChild(bottomBar);	
}
writeBottomBar.clear=function(){
	returnDateTo.value='';
};
...
function initCalendar()
{
	...
	calendarDiv.onmouseover = function(){
		writeBottomBar.dis = true;
	};
	calendarDiv.onmouseout = function(){
		writeBottomBar.dis = false;
	};
	document.onmousedown = function(){
		if(!writeBottomBar.dis)closeCalendar();
	};
}
