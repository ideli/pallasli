	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl: UE.leipiFormDesignUrl+'/text.html',
				name:thePlugins,
				editor:this,
				title: '文本框',
...
UE.plugins['macros'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/macros.html',
                name:thePlugins,
                editor:this,
                title: '宏控件',
...
UE.plugins['radio'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/radio.html',
                name:thePlugins,
                editor:this,
                title: '单选框',
...
UE.plugins['checkbox'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/checkbox.html',
                name:thePlugins,
                editor:this,
                title: '复选框',
...
UE.plugins['radios'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/radios.html',
                name:thePlugins,
                editor:this,
                title: '单选框组',
                cssRules:"width:590px;height:370px;",
...
UE.plugins['checkboxs'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/checkboxs.html',
                name:thePlugins,
                editor:this,
                title: '复选框组',
...
UE.plugins['textarea'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/textarea.html',
                name:thePlugins,
                editor:this,
                title: '多行文本框',
...
UE.plugins['select'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/select.html',
                name:thePlugins,
                editor:this,
                title: '下拉菜单',
                cssRules:"width:590px;height:370px;",
...
UE.plugins['progressbar'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/progressbar.html',
                name:thePlugins,
                editor:this,
                title: '进度条',
...
UE.plugins['qrcode'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/qrcode.html',
                name:thePlugins,
                editor:this,
                title: '二维码',
...
UE.plugins['listctrl'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/listctrl.html',
                name:thePlugins,
                editor:this,
                title: '列表控件',
...
UE.plugins['more'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/more.html',
                name:thePlugins,
                editor:this,
...
UE.plugins['error'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/error.html',
                name:thePlugins,
                editor:this,
                title: '异常提示',
...
UE.plugins['leipi'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/leipi.html',
                name:thePlugins,
                editor:this,
                title: '表单设计器 - 清单',
...
UE.plugins['leipi_template'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.leipiFormDesignUrl+'/template.html',
                name:thePlugins,
                editor:this,
                title: '表单模板',
