...
import monitor.spout.MetaSpout;
import monitor.spout.StringScheme;
import monitor.utils.Constant;
import monitor.utils.PropertyUtil;
import monitor.utils.ReflectionUtil;
...
public class TopoMain {
	...
	public static void main(String[] args) throws Exception {
		if (args.length != 2) {
			...
			System.err.println(
					"such as : ./storm jar  /home/topo.jar cn.itcast.storm.topology.TopoMain topo-1 topology.xml");
			System.exit(2);
		}
	 ...
	 */
	private static void buildTopology(TopologyBuilder topologybuilder, MetaClientConfig metaClientConfig,
