...
public class PartitionManager {
	...
	public void commit() {
		...
		if (lastCompletedOffset != lastCommittedOffset()) {
			LOG.info("Writing last completed offset (" + lastCompletedOffset + ") to ZK for " + _partition
			...
			LOG.info("Wrote last completed offset (" + lastCompletedOffset + ") to ZK for " + _partition
					+ " for topology: " + _topologyInstanceId);
		} else {
