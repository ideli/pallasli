...
/**
 * Logging Event Wraps a log4j LoggingEvent object. Wrapping is required by some
 * information is lost when the LoggingEvent is serialized. The idea is to
 * extract all information required from the LoggingEvent object, place it in
 * the wrapper and then serialize the LoggingEventWrapper. This way all required
 * data remains available to us.
 * 
 * @author faheem
 *
 */
