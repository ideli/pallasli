...
import com.shineyue.util.DateUtil;

/**
 * 该类用于表示数据库查询结果中的行,它包含一个Column对象的集合.
 * 用向量来保存基本结果集中列的顺序.
 * 调用时请优先调用getDef****方法返回字段值;
 * 所有getDef***方法增加了判断Null值填入缺省值检查
 */
public class Row
{
...
//  private int databaseType = ShareData.DB_TYPE_SYBASE;
  ...
  public Row(ResultSet rs) throws SQLException, UnsupportedTypeException
  {
	...
	{		
      ...
      switch (type)
	  {
		...
		case Types.DECIMAL:
		case Types.NUMERIC:	
		  columns[i - 1] = new BigDecimalColumn(colname, rs.getBigDecimal(colname));//, rsmd.getScale(i)));
  ...
  public BigDecimal getBigDecimal(int columnIndex) throws NoSuchColumnException,
  ...
  public Timestamp getTimestamp(int columnIndex) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
	Column col = null;
	try
  ...
  public Timestamp getTimestamp(String columnName) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public double getDefDouble(int columnIndex,
							 double value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
	Column col = null;
	double ret = 0D;
  ...
  public double getDefDouble(String columnName,
							 double value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public String getDefString(int columnIndex,
							 String value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
	Column col = null;
	String ret = "";
  ...
  public String getDefString(String columnName,
							 String value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public String getTrimString(String columnName) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
	return getDefString(getIndex(columnName), "").trim();
  }
  
  public long getDefLong(int columnIndex, long value) throws NoSuchColumnException,
      UnsupportedConversionException
  {
     Column col = null;
     long ret = 0;
  ...
  public long getDefLong(String columnName,long value) throws NoSuchColumnException,
     UnsupportedConversionException
  {
  ...
  public int getDefInt(int columnIndex,
					   int value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
	Column col = null;
	int ret = 0;
  ...
  public int getDefInt(String columnName,
					   int value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public short getDefShort(int columnIndex,
						   short value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
	Column col = null;
	short ret = (short)0;
  ...
  public short getDefShort(String columnName,
						   short value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public java.util.Date getDefDate(int columnIndex) throws
	  NoSuchColumnException, UnsupportedConversionException
  {
	return getDefDate(columnIndex, new java.util.Date());
  }

  public java.util.Date getDefDate(String columnName) throws
	  NoSuchColumnException, UnsupportedConversionException
  {
	return getDefDate(getIndex(columnName), new java.util.Date());
  }
  
  public java.util.Date getDefNullDate(int columnIndex) throws
    NoSuchColumnException, UnsupportedConversionException
  {
    return getDefDate(columnIndex, null);
  }

  public java.util.Date getDefNullDate(String columnName) throws
  NoSuchColumnException, UnsupportedConversionException
  {
   ...
   */
  public String getDateToString(int columnIndex) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
	...
	{
	  return DateUtil.formatDate(ret, "yyyy-MM-dd");
	}
  }

  public String getDateToString(String columnName) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
   ...
   * @throws UnsupportedConversionException
   */
  public String getDateTimeToString(int columnIndex) throws
	  NoSuchColumnException, UnsupportedConversionException
  {
	java.util.Date ret = getDefDate(columnIndex, null);
	if (ret == null)
  ...
  public String getDateTimeToString(String columnName) throws
	  NoSuchColumnException, UnsupportedConversionException
  {
   ...
   * @throws UnsupportedConversionException
   */
  public String getDefDateToString(int columnIndex) throws
	  NoSuchColumnException, UnsupportedConversionException
  {
	return DateUtil.formatDate(getDefDate(columnIndex),
		"yyyy-MM-dd");
  }

  public String getDefDateToString(String columnName) throws
	  NoSuchColumnException, UnsupportedConversionException
  {
	return getDateToString(getIndex(columnName));
  }

  public boolean getDefBoolean(int columnIndex, boolean value) throws
  ...
  public boolean getDefBoolean(String columnName, boolean value) throws
	  NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public boolean getDefBoolean(String columnName) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
   ...
   * */
  public double getDoubleOrDefault(int columnIndex,
								   double value) throws NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public void setDouble(int columnIndex, double value) throws
	  NoSuchColumnException,
	  UnsupportedConversionException
  {
	Column col = null;
  ...
  public void setDouble(String columnName, double value) throws
	  NoSuchColumnException,
	  UnsupportedConversionException
  {
  ...
  public void setBigDecimal(int columnIndex, BigDecimal value) throws
	  NoSuchColumnException,
	  UnsupportedConversionException
  {
	Column col = null;
  ...
  public void setBigDecimal(String columnName, BigDecimal value) throws
	  NoSuchColumnException, UnsupportedConversionException
  {
