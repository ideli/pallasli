...
<%@page import="net.sf.jasperreports.engine.design.JRDesignStaticText"%>
<%@page import="net.sf.jasperreports.engine.design.JRDesignBand"%>
<%@page import="net.sf.jasperreports.engine.xml.JRBandFactory"%>
...
System.out.println(application.getRealPath("/reports/test.jasper"));
JasperCompileManager.compileReportToFile(design,application.getRealPath("/reports/test.jasper"));
