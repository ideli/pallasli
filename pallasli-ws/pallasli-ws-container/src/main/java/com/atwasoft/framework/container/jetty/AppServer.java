package com.atwasoft.framework.container.jetty;
...
import com.atwasoft.framework.container.entity.*;
...
public class AppServer extends Thread
{
	...
	public void run() {
        try
        {
	        ...
	        XmlConfiguration config = new XmlConfiguration(new FileInputStream(ContainerEnv.getInstance().getContainerConfigFile())); 
